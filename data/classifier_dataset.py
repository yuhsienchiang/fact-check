...
ClassifierPassage = namedtuple('ClassifierPassage', ['input_ids', 'token_type_ids', 'attention_mask'])
...
class ClassifierDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        query_label = class_label_conv(data["claim_label"]) if self.data_type == "train" else None
    ...
    def train_collate_fn(self, batch):
        ...
        for batch_sample in batch:
            ...
            text_sequences_passage = ClassifierPassage(input_ids=torch.stack(batch_text_sequence_input_ids, dim=0),
                                                       token_type_ids=torch.stack(batch_text_sequence_token_type_ids, dim=0) if batch_text_sequence_token_type_ids else None,
